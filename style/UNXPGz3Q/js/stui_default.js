...
var stui = {
	...
	'images': {
		...
		'qrcode': function() {
			$("img.qrcode").attr("src", "https://api.qrserver.com/v1/create-qr-code/?data=" + encodeURIComponent(stui.browser.url) + "")
		}
	},
	'common': {
		'stylecolor': function() {
	        ...
	        $(".gray-color").click(function(){
	            $("link[name='skin']").attr({href:"/style/css/stui_color-gray.css"});
	            createCookie('stylecolor',"/style/css/stui_color-gray.css",365);
	        });
	        $(".gules-color").click(function(){
	            $("link[name='skin']").attr({href:"/style/css/stui_color-gules.css"});
	            createCookie('stylecolor',"/style/css/stui_color-gules.css",365);
	        }); 
	        $(".blue-color").click(function(){
	            $("link[name='skin']").attr({href:"/style/css/stui_color-blue.css"});
	            createCookie('stylecolor',"/style/css/stui_color-blue.css",365);
	        });
	        $(".green-color").click(function(){
	            $("link[name='skin']").attr({href:"/style/css/stui_color-green.css"});
	            createCookie('stylecolor',"/style/css/stui_color-green.css",365);
	        }); 
		...
		'share': function(){
			window._bd_share_config={"common":{"bdSnsKey":{},"bdText":"","bdMini":"2","bdMiniList":false,"bdPic":"","bdStyle":"0","bdSize":"24"},"share":{}};with(document)0[(getElementsByTagName("head")[0]||body).appendChild(createElement('script')).src='https://177382.com/Public/static/api/js/share.js?v=89860593.js?cdnversion='+~(-new Date()/36e5)];
		}
	}	
};
